...
gem 'enju_bookmark', '~> 0.1.2.pre2'
gem 'enju_resource_merge', '~> 0.1.0.pre2'
gem 'enju_circulation', '~> 0.1.0.pre4'
gem 'enju_message', '~> 0.1.13'
gem 'enju_inter_library_loan', '~> 0.1.0.pre2'
gem 'enju_inventory', '~> 0.1.11.pre'
gem 'enju_event', '~> 0.1.17.pre2'
