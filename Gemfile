...
gem 'enju_subject', '~> 0.0.17'
gem 'enju_purchase_request', '~> 0.0.13'
gem 'enju_question', '~> 0.0.20'
gem 'enju_bookmark', '~> 0.0.21'
gem 'enju_resource_merge', '~> 0.0.16'
gem 'enju_circulation', '~> 0.0.69'
gem 'enju_message', '~> 0.0.24'
#gem 'enju_inter_library_loan', '>= 0.0.5'
gem 'enju_inventory', '~> 0.0.10'
gem 'enju_event', '~> 0.0.26'
#gem 'enju_news', '~> 0.0.4'
