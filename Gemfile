...
gem 'enju_biblio', '~> 0.1.0.pre29'
gem 'enju_library', '~> 0.1.0.pre17'
gem 'enju_flower', '~> 0.1.0.pre3'
...
gem 'enju_circulation', '~> 0.1.0.pre18'
gem 'enju_message', '~> 0.1.4.pre16'
