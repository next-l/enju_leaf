class AddNumberOfDayToNotifyOverdueToUserGroup < ActiveRecord::Migration
  def self.up
    ...
    add_column :user_groups, :number_of_time_to_send_overdue_notification, :integer, :default => 3, :null => false
  end

  def self.down
    remove_column :user_groups, :number_of_time_to_send_overdue_notification
