= Next-L Enju Leaf
{<img src="https://travis-ci.org/next-l/enju_leaf.svg?branch=1.4" alt="Build Status" />}[https://travis-ci.org/next-l/enju_leaf]
{<img src="https://coveralls.io/repos/next-l/enju_leaf/badge.svg?branch=1.4&service=github" alt="Coverage Status" />}[https://coveralls.io/github/next-l/enju_leaf?branch=1.4]
{<img src="https://hakiri.io/github/next-l/enju_leaf/1.4.svg" alt="security" />}[https://hakiri.io/github/next-l/enju_leaf/1.4]
