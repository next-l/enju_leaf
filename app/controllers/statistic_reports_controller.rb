...
=end
      ...
      5.downto(1) do |i|
        data_type = 122
        report.page.list(:list).add_row do |row|
          row.item(:option).value(t("statistic_report.user_type_#{i}"))
          sum = 0
          12.times do |t|
            if t < 4 # for Japanese fiscal year
  ...
  def get_monthly_report_csv(term)
    ...
    File.open(csv_file, "w") do |output|
      ...
      columns.each do |column|
        case column[0]
        when :type
          row << t('statistic_report.items')
        when :library
          row << t('statistic_report.all_library')
        when :option
          row << ""
        when "sum"
      ...
      columns.each do |column|
        case column[0]
        when :type
          row << t('statistic_report.checkout_users')
        when :library
          row << t('statistic_report.all_library')
        when :option
          row << ""
      ...
      5.downto(1) do |i|
        ...
        columns.each do |column|
          ...
          when :library
            row << t('statistic_report.all_library')
          when :option
            row << t("statistic_report.user_type_#{i}")
          when "sum"
            row << to_format(sum)
          else
      ...
      columns.each do |column|
        case column[0]
        when :type
          row << t('statistic_report.average_checkout_users')
        when :library
          row << t('statistic_report.all_library')
        when :option
          row << ""
      ...
      columns.each do |column|
        case column[0]
        when :type
          row << t('statistic_report.checkout_items')
        when :library
          row << t('statistic_report.all_library')
        when :option
          row << ""
      ...
      3.times do |i|
        ...
        columns.each do |column|
          ...
          when :library
            row << t('statistic_report.all_library')
          when :option
            row << t("statistic_report.item_type_#{i+1}")
          when "sum"
            row << to_format(sum)
          else
      ...
      user_groups.each do |user_group|
        ...
        columns.each do |column|
          case column[0]
          when :type
            row << t('statistic_report.checkout_items_each_user_groups')
          when :library
            row << t('statistic_report.all_library')
          when :option
      ...
      columns.each do |column|
        case column[0]
        when :type
          row << t('statistic_report.average_checkout_items')
        when :library
          row << t('statistic_report.all_library')
        when :option
          row << ""
      ...
      columns.each do |column|
        case column[0]
        when :type
          row << t('statistic_report.checkin_items')
        when :library
          row << t('statistic_report.all_library')
        when :option
          row << ""
      ...
      columns.each do |column|
        case column[0]
        when :type
          row << t('statistic_report.average_checkin_items')
        when :library
          row << t('statistic_report.all_library')
        when :option
          row << ""
      ...
      columns.each do |column|
        case column[0]
        when :type
          row << t('statistic_report.users')
        when :library
          row << t('statistic_report.all_library')
        when :option
          row << t('statistic_report.all_users')
        when "sum"
      ...
      columns.each do |column|
        ...
        when :library
          row << t('statistic_report.all_library')
        when :option
          row << t('statistic_report.unlocked_users')
        when "sum"
      ...
      columns.each do |column|
        ...
        when :library
          row << t('statistic_report.all_library')
        when :option
          row << t('statistic_report.locked_users')
        when "sum"
      ...
      columns.each do |column|
        ...
        when :library
          row << t('statistic_report.all_library')
        when :option
          row << t('statistic_report.user_provisional')
        when "sum"
      ...
      columns.each do |column|
       case column[0]
        when :type
          row << t('statistic_report.reserves')  
        when :library
          row << t('statistic_report.all_library')
        when :option
          row << ""
      ...
      columns.each do |column|
       case column[0]
        ...
        when :library
          row << t('statistic_report.all_library')
        when :option
          row << t('statistic_report.on_counter')
        when "sum"
          row << to_format(sum)
        else
      ...
      columns.each do |column|
       case column[0]
        ...
        when :library
          row << t('statistic_report.all_library')
        when :option
          row << t('statistic_report.from_opac')
        when "sum"
          row << to_format(sum)
        else
      ...
      columns.each do |column|
        case column[0]
        when :type
          row << t('statistic_report.questions')
        when :library
          row << t('statistic_report.all_library')
        when :option
          row << ""
      ...
      columns.each do |column|
        case column[0]
        when :type
          row << t('statistic_report.visiters')
        when :library
          row << t('statistic_report.all_library')
        when :option
          row << ""
      ...
      columns.each do |column|
        case column[0]
        when :type
          row << t('statistic_report.consultations')
        when :library
          row << t('statistic_report.all_library')
        when :option
          row << ""
    ...
    send_file csv_file, :filenamme => "#{term}_monthly_report.csv", :type => 'text/csv', :disposition => 'attachment'
  end
  ...
  def get_daily_report
    ...
    begin
      ...
      [1,14,27].each do |start_date| # for 3 pages
        ...
        if start_date != 27
          13.times do |t|
            report.page.list(:list).header.item("column##{t+1}").value(t('statistic_report.date', :num => t+start_date))
          end
        else
        ...
        5.downto(1) do |type|
          report.page.list(:list).add_row do |row|
            row.item(:option).value(t("statistic_report.user_type_#{type}"))
            if start_date != 27
              13.times do |t|
  ...
  def get_daily_report_csv(term)
      ...
      5.downto(1) do |type|
        ...
        columns.each do |column|
          ...
          when :library
            row << t('statistic_report.all_library')
          when :option
            row << t("statistic_report.user_type_#{type}")
          when "sum"
            row << to_format(sum)
          else
    ...
    send_file csv_file, :filenamme => "#{term}_daily_report.csv", :type => 'text/csv', :disposition => 'attachment'
  end
