...
# ### Indexes
#
# * `index_resource_import_file_transitions_on_file_id`:
#     * **`resource_import_file_id`**
# * `index_resource_import_file_transitions_on_sort_key_and_file_id` (_unique_):
#     * **`sort_key`**
#     * **`resource_import_file_id`**
# * `index_resource_import_file_transitions_parent_most_recent` (_unique_ _where_ most_recent):
#     * **`resource_import_file_id`**
#     * **`most_recent`**
#
