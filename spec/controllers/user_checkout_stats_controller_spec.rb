...
describe UserCheckoutStatsController do
  ...
  describe "GET index" do
    before(:each) do
      Factory.create(:user_checkout_stat)
    end
  ...
  describe "GET show" do
    describe "When logged in as Administrator" do
      ...
      it "assigns the requested user_checkout_stat as @user_checkout_stat" do
        user_checkout_stat = Factory.create(:user_checkout_stat)
  ...
  describe "POST create" do
    before(:each) do
      @attrs = Factory.attributes_for(:user_checkout_stat)
  ...
  describe "PUT update" do
    before(:each) do
      @user_checkout_stat = Factory(:user_checkout_stat)
      @attrs = Factory.attributes_for(:user_checkout_stat)
      @invalid_attrs = {:start_date => ''}
    end
