...
describe SubjectHasClassificationsController do
  ...
  describe "GET index" do
    before(:each) do
      Factory.create(:subject_has_classification)
    end
  ...
  describe "GET show" do
    describe "When logged in as Administrator" do
      ...
      it "assigns the requested subject_has_classification as @subject_has_classification" do
        subject_has_classification = Factory.create(:subject_has_classification)
  ...
  describe "POST create" do
    before(:each) do
      @attrs = Factory.attributes_for(:subject_has_classification)
  ...
  describe "PUT update" do
    before(:each) do
      @subject_has_classification = Factory(:subject_has_classification)
      @attrs = Factory.attributes_for(:subject_has_classification)
      @invalid_attrs = {:subject_id => ''}
    end
