...
describe BookmarkStatHasManifestationsController do
  ...
  describe "GET index" do
    before(:each) do
      Factory.create(:bookmark_stat_has_manifestation)
    end
  ...
  describe "GET show" do
    describe "When logged in as Administrator" do
      ...
      it "assigns the requested bookmark_stat_has_manifestation as @bookmark_stat_has_manifestation" do
        bookmark_stat_has_manifestation = Factory.create(:bookmark_stat_has_manifestation)
  ...
  describe "POST create" do
    before(:each) do
      @attrs = Factory.attributes_for(:bookmark_stat_has_manifestation)
  ...
  describe "PUT update" do
    before(:each) do
      @bookmark_stat_has_manifestation = Factory(:bookmark_stat_has_manifestation)
      @attrs = Factory.attributes_for(:bookmark_stat_has_manifestation)
      @invalid_attrs = {:bookmark_stat_id => ''}
    end
