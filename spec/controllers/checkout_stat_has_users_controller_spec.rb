...
describe CheckoutStatHasUsersController do
  ...
  describe "GET index" do
    before(:each) do
      Factory.create(:checkout_stat_has_user)
    end
  ...
  describe "GET show" do
    describe "When logged in as Administrator" do
      ...
      it "assigns the requested checkout_stat_has_user as @checkout_stat_has_user" do
        checkout_stat_has_user = Factory.create(:checkout_stat_has_user)
  ...
  describe "POST create" do
    before(:each) do
      @attrs = Factory.attributes_for(:checkout_stat_has_user)
  ...
  describe "PUT update" do
    before(:each) do
      @checkout_stat_has_user = Factory(:checkout_stat_has_user)
      @attrs = Factory.attributes_for(:checkout_stat_has_user)
      @invalid_attrs = {:user_checkout_stat_id => ''}
    end
