...
describe ManifestationReserveStatsController do
  ...
  describe "GET index" do
    before(:each) do
      Factory.create(:manifestation_reserve_stat)
    end
  ...
  describe "GET show" do
    describe "When logged in as Administrator" do
      ...
      it "assigns the requested manifestation_reserve_stat as @manifestation_reserve_stat" do
        manifestation_reserve_stat = Factory.create(:manifestation_reserve_stat)
  ...
  describe "POST create" do
    before(:each) do
      @attrs = Factory.attributes_for(:manifestation_reserve_stat)
  ...
  describe "PUT update" do
    before(:each) do
      @manifestation_reserve_stat = Factory(:manifestation_reserve_stat)
      @attrs = Factory.attributes_for(:manifestation_reserve_stat)
      @invalid_attrs = {:start_date => ''}
    end
