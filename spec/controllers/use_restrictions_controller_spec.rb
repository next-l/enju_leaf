...
describe UseRestrictionsController do
  ...
  describe 'GET index' do
    ...
    describe 'When logged in as Administrator' do
      ...
      it 'assigns all use_restrictions as @use_restrictions' do
        get :index
        expect(assigns(:use_restrictions)).to eq(UseRestriction.order(:position))
      end
    end
    ...
    describe 'When logged in as User' do
      ...
      it 'should be forbidden' do
        get :index
        expect(assigns(:use_restrictions)).to be_nil
  ...
  describe 'GET show' do
    describe 'When logged in as Administrator' do
      ...
      it 'assigns the requested use_restriction as @use_restriction' do
        ...
        expect(assigns(:use_restriction)).to eq(use_restriction)
      end
    end
  ...
  describe 'GET new' do
    describe 'When logged in as Administrator' do
      ...
      it 'should be forbidden' do
        get :new
        expect(assigns(:use_restriction)).to be_nil
        expect(response).to be_forbidden
      end
    end
    ...
    describe 'When logged in as Administrator' do
      ...
      describe 'with valid params' do
        ...
        it 'moves its position when specified' do
          ...
          expect(response).to redirect_to(use_restrictions_url)
        end
      end
