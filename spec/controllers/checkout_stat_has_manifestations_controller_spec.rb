...
describe CheckoutStatHasManifestationsController do
  ...
  describe "GET index" do
    before(:each) do
      Factory.create(:checkout_stat_has_manifestation)
    end
  ...
  describe "GET show" do
    describe "When logged in as Administrator" do
      ...
      it "assigns the requested checkout_stat_has_manifestation as @checkout_stat_has_manifestation" do
        checkout_stat_has_manifestation = Factory.create(:checkout_stat_has_manifestation)
  ...
  describe "POST create" do
    before(:each) do
      @attrs = Factory.attributes_for(:checkout_stat_has_manifestation)
  ...
  describe "PUT update" do
    before(:each) do
      @checkout_stat_has_manifestation = Factory(:checkout_stat_has_manifestation)
      @attrs = Factory.attributes_for(:checkout_stat_has_manifestation)
      @invalid_attrs = {:manifestation_checkout_stat_id => ''}
    end
