...
describe UserReserveStatsController do
  ...
  describe "GET index" do
    before(:each) do
      Factory.create(:user_reserve_stat)
    end
  ...
  describe "GET show" do
    describe "When logged in as Administrator" do
      ...
      it "assigns the requested user_reserve_stat as @user_reserve_stat" do
        user_reserve_stat = Factory.create(:user_reserve_stat)
  ...
  describe "POST create" do
    before(:each) do
      @attrs = Factory.attributes_for(:user_reserve_stat)
  ...
  describe "PUT update" do
    before(:each) do
      @user_reserve_stat = Factory(:user_reserve_stat)
      @attrs = Factory.attributes_for(:user_reserve_stat)
      @invalid_attrs = {:start_date => ''}
    end
