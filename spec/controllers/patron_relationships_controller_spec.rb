...
describe PatronRelationshipsController do
  ...
  describe "GET index" do
    before(:each) do
      Factory.create(:patron_relationship)
    end
  ...
  describe "GET show" do
    describe "When logged in as Administrator" do
      ...
      it "assigns the requested patron_relationship as @patron_relationship" do
        patron_relationship = Factory.create(:patron_relationship)
  ...
  describe "POST create" do
    before(:each) do
      @attrs = Factory.attributes_for(:patron_relationship)
  ...
  describe "PUT update" do
    before(:each) do
      @patron_relationship = Factory(:patron_relationship)
      @attrs = Factory.attributes_for(:patron_relationship)
      @invalid_attrs = {:parent_id => ''}
    end
