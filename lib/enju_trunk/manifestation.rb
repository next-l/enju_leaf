...
class Manifestation < ActiveRecord::Base
  ...
  enju_subject_manifestation_model
	enju_circulation_manifestation_model
  #enju_amazon
  enju_oai
  #enju_calil_check
  #enju_cinii
  ...
  after_destroy :index_series_statement
	attr_accessible :original_title, :manifestation_type_id
  ...
  attr_accessible :publisher, :publisher_transcription, :carrier_type_id
